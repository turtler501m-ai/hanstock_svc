...
def _balance_sync_strategy_id(trade: dict) -> str:
    from src.dashboard.services.order_reconciliation import balance_sync_strategy_id
    return balance_sync_strategy_id(trade)


def _strategy_position_quantities(trades: list[dict]) -> dict[str, dict[str, int]]:
    from src.dashboard.services.order_reconciliation import strategy_position_quantities
    return strategy_position_quantities(
        trades,
        account_trades=_account_trades,
        trade_is_ok=_trade_is_ok,
        attributed_reason=_ATTRIBUTED_BALANCE_SYNC_REASON,
    )
...
def _allocate_strategy_reconciliation(
    ...
    *,
    ...
    from src.dashboard.services.order_reconciliation import allocate_strategy_reconciliation
    return allocate_strategy_reconciliation(qty, strategy_quantities, action=action)
