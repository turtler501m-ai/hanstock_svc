...
```text
cache policy (완료)
  → dashboard common API / formatters / UI / market regime / strategy audit / AI allocation / candidate history / reconciliation screen (진행 중)
