...
AI_DETAIL_MODAL_JS = (
    ROOT / "web" / "static" / "js" / "dashboard-ai-detail-modal.js"
).read_text(encoding="utf-8")
STRATEGY_SETTINGS_SAVE_JS = (
    ROOT / "web" / "static" / "js" / "dashboard-strategy-settings-save.js"
).read_text(encoding="utf-8")
STRATEGY_CONTEXT_JS = (
...
SCHEDULER_SUMMARY_JS = (
    ROOT / "web" / "static" / "js" / "dashboard-scheduler-summary.js"
).read_text(encoding="utf-8")
...
class MarketRegimeDashboardFrontendContractTests(unittest.TestCase):
    def test_market_regime_presentation_module_loads_before_app(self):
        ...
        app_tag = '<script src="/static/js/app.js?v=77"></script>'
